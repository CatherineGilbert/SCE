...
-   "Genetics" refers to the cultivar maturity designation. 
    ...
    -   When using the "Direct" maturity handling, or working with any crop besides soybean and maize, Genetics is the exact name of the APSIM cultivar that will be referenced for the developmental timing. 
...
**When running an analysis with a template model for a new crop, we must set the Maturity Handling to Direct** so that the analysis parses the Genetics information as the direct names of the APSIM cultivars you will be using to define the crop's phenology.
