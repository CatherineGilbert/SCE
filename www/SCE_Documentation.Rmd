...
Because this is an APSIM file, you can also customize the outputs of the simulations through the Reporting Variables module. This allows you to create a seasonal covariate, reported at each stage of development, for practically any parameter within the APSIM model. At minimum, Date, DOY, Stage, SimSowDate, SimMatDate, SimHarvestDate, Yieldkgha, Rain, ThermalTime, AccEmTT, and Result need to be included in the template's reporting variables or else later analysis will break. 
...
At lines 14, 15, and 22 of the Report module, substitute the new crop in the variable path (ex: "[Maize].Phenology.ThermalTime as ThermalTime" becomes "[Wheat].Phenology.ThermalTime as ThermalTime").
