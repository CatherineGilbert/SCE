...
2. Download and install a copy of Next-Gen APSIM, if you don't have one. 
3. Download and install both R and an IDE like RStudio, if you don't have them. 
4. Open your R IDE

The SCE can be downloaded directly from its GitHub repository, in which case starting the app is as simple as launching "app.R." Using the SCE this way requires that a copy of Next-Gen APSIM be available on the computer . The app will also require a number of R packages be installed-- when opening the SCE app and analysis script through an IDE such as RStudio, the user will be prompted to download these packages before running the scripts.
